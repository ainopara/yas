...
impl ArtifactSetKey {
    pub fn from_zh_cn(s: &str) -> Option<ArtifactSetKey> {
        ...
        match s {
            ...
            "魔战士的羽面" | "巡山客的信标" | "驯兽师的护符" | "秘术家的金盘" | "游学者的爪杯" => Some(ArtifactSetKey::ScrollOfTheHeroOfCinderCity),
            "诸圣的礼冠" | "灵髓的根脉" | "异种的期许" | "夜域的迷思" | "纷争的前宴" => Some(ArtifactSetKey::ObsidianCodex),
            "深廊的遂失之冕" | "深廊的漫远之约" | "深廊的回奏之歌" | "深廊的湮落之刻" | "深廊的饫赐之宴" => Some(ArtifactSetKey::LongNightsOath),
            "被浸染的缨盔" | "夜鸣莺的尾羽" | "执灯人的誓词" | "不死者的哀铃" | "未吹响的号角" => Some(ArtifactSetKey::FinaleOfTheDeepGalleries),
            _ => None,
        }
    }
}
...
impl ArtifactSlotKey {
    pub fn from_zh_cn(s: &str) -> Option<ArtifactSlotKey> {
        ...
        match s {
            ...
            "魔战士的羽面" => Some(ArtifactSlotKey::Circlet),
            "巡山客的信标" => Some(ArtifactSlotKey::Plume),
            "驯兽师的护符" => Some(ArtifactSlotKey::Flower),
            "秘术家的金盘" => Some(ArtifactSlotKey::Sands),
            "游学者的爪杯" => Some(ArtifactSlotKey::Goblet),
            "诸圣的礼冠" => Some(ArtifactSlotKey::Circlet),
            "灵髓的根脉" => Some(ArtifactSlotKey::Plume),
            "异种的期许" => Some(ArtifactSlotKey::Flower),
            "夜域的迷思" => Some(ArtifactSlotKey::Sands),
            "纷争的前宴" => Some(ArtifactSlotKey::Goblet),
            "被浸染的缨盔" => Some(ArtifactSlotKey::Circlet),
            "夜鸣莺的尾羽" => Some(ArtifactSlotKey::Plume),
            "执灯人的誓词" => Some(ArtifactSlotKey::Flower),
            "不死者的哀铃" => Some(ArtifactSlotKey::Sands),
            "未吹响的号角" => Some(ArtifactSlotKey::Goblet),
            "深廊的遂失之冕" => Some(ArtifactSlotKey::Circlet),
            "深廊的漫远之约" => Some(ArtifactSlotKey::Plume),
            "深廊的回奏之歌" => Some(ArtifactSlotKey::Flower),
            "深廊的湮落之刻" => Some(ArtifactSlotKey::Sands),
            "深廊的饫赐之宴" => Some(ArtifactSlotKey::Goblet),
            _ => None,
        }
    }
}
