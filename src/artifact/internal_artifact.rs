...
impl ArtifactSetKey {
    pub fn from_zh_cn(s: &str) -> Option<ArtifactSetKey> {
        ...
        match s {
            ...
            "深廊的遂失之冕" | "深廊的漫远之约" | "深廊的回奏之歌" | "深廊的湮落之刻" | "深廊的饫赐之宴" => Some(ArtifactSetKey::FinaleOfTheDeepGalleries),
            "被浸染的缨盔" | "夜鸣莺的尾羽" | "执灯人的誓词" | "不死者的哀铃" | "未吹响的号角" => Some(ArtifactSetKey::LongNightsOath),
            _ => None,
        }
    }
}
